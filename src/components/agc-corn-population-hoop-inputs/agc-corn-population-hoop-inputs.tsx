...
@Component({
    tag: 'agc-crop-population-hoop-inputs'
})
                ...
                <div style={{display: this.ready ? 'block' : 'none'}}>
                    {this.data && (<ul class="agc-results">
                            <li>
                                ...
                                <span class="agc-results__value">{numberWithCommas(this.data['standCount'])}</span>
                                <sub data-i18n={`results.plants`}>plants</sub>
                            </li>
                            <li>
                                <h2 data-i18n="results.hoop-diameter">Hoop Diameter</h2>
                                <span class="agc-results__value">{numberWithCommas(this.data['hoopDiameter'])}</span>
                                <sub data-i18n={`results.hoop-diameter-${this.data['units']['diameter']}`}>{this.data['units']['diameter']}</sub>
                            </li>                     
                        </ul>)}
                </div>
            </section>
